...
pub type TransferPallet = transfer_pallet::Pallet<Runtime>;
...
/// All pallets included in the runtime as a nested tuple of types.
pub type AllPalletsWithSystem = (System, SimplePallet, TransferPallet,);
/// All pallets included in the runtime as a nested tuple of types.
/// Excludes the System pallet.
pub type AllPalletsWithoutSystem = ((SimplePallet, (TransferPallet,)));
/// All pallets included in the runtime as a nested tuple of types in reversed order.
/// Excludes the System pallet.
pub type AllPalletsWithoutSystemReversed = ((TransferPallet, (SimplePallet,)));
/// All pallets included in the runtime as a nested tuple of types in reversed order.
pub type AllPalletsWithSystemReversed = ((TransferPallet, (SimplePallet, (System,))));
/// All pallets included in the runtime as a nested tuple of types in reversed order.
    ...
    for PalletInfo
{
    fn index<P: 'static>() -> Option<usize> {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < TransferPallet > () { return Some (2usize) }
        None
    }
    fn name<P: 'static>() -> Option<&'static str> {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < TransferPallet > () { return Some ("TransferPallet") }
        None
    }
    fn module_name<P: 'static>() -> Option<&'static str> {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < TransferPallet > () { return Some ("transfer_pallet") }
        None
    }
    ...
    ) -> Option<self::sp_api_hidden_includes_construct_runtime::hidden_include::traits::CrateVersion>
    {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < TransferPallet > () { return Some (< transfer_pallet :: Pallet < Runtime > as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: traits :: PalletInfoAccess > :: crate_version ()) }
        None
    }
}
pub enum Call {
...
impl ::core::clone::Clone for Call {
    ...
    fn clone(&self) -> Call {
        match (&*self,) {
            ...
            (&Call::TransferPallet(ref __self_0),) => {
                Call::TransferPallet(::core::clone::Clone::clone(&*__self_0))
            }
        }
    }
}
    ...
    fn eq(&self, other: &Call) -> bool {
        {
            ...
            if __self_vi == __arg_1_vi {
                match (&*self, &*other) {
                    ...
                    (&Call::TransferPallet(ref __self_0), &Call::TransferPallet(ref __arg_1_0)) => {
                        *__self_0 == *__arg_1_0
                    }
                    _ => unsafe { ::core::intrinsics::unreachable() },
                }
    ...
    fn assert_receiver_is_total_eq(&self) -> () {
        {
            ...
            let _ : :: core :: cmp :: AssertParamIsEq < self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: dispatch :: CallableCallFor < TransferPallet , Runtime > > ;
        }
    }
}
#[allow(deprecated)]
        ...
        fn decode<__CodecInputEdqy: ::codec::Input>(
                ...
                .map_err(|e| e.chain("Could not decode `Call`, failed to read variant byte"))?
            {
                ...
                __codec_x_edqy if __codec_x_edqy == 2u8 as ::core::primitive::u8 => {
                    ::core::result::Result::Ok(Call::TransferPallet({
                        let __codec_res_edqy = < self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: dispatch :: CallableCallFor < TransferPallet , Runtime > as :: codec :: Decode > :: decode (__codec_input_edqy) ;
                        match __codec_res_edqy {
                            ::core::result::Result::Err(e) => {
                                return ::core::result::Result::Err(
                                    e.chain("Could not decode `Call::TransferPallet.0`"),
                                )
                            }
                            ::core::result::Result::Ok(__codec_res_edqy) => __codec_res_edqy,
                        }
...
impl core::fmt::Debug for Call {
    fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::TransferPallet(ref a0) => {
                fmt.debug_tuple("Call::TransferPallet").field(a0).finish()
            }
            _ => Ok(()),
        }
    }
    ...
    for Call
{
    ...
    ) -> self::sp_api_hidden_includes_construct_runtime::hidden_include::dispatch::DispatchInfo
    {
        match self {
            ...
            Call::TransferPallet(call) => call.get_dispatch_info(),
        }
    }
}
    ...
    for Call
{
    ...
    ) -> self::sp_api_hidden_includes_construct_runtime::hidden_include::dispatch::CallMetadata
    {
        ...
        match self {
            ...
            Call::TransferPallet(call) => {
                let function_name = call.get_call_name();
                let pallet_name = "TransferPallet";
                self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: dispatch :: CallMetadata { function_name , pallet_name , }
            }
        }
    }
    fn get_module_names() -> &'static [&'static str] {
        &["System", "SimplePallet", "TransferPallet"]
    }
    fn get_call_names(module: &str) -> &'static [&'static str] {
        ...
        match module {
            ...
            "TransferPallet" => {
                <<TransferPallet as Callable<Runtime>>::Call as GetCallName>::get_call_names()
            }
    ...
    > for Call
{
    ...
    > {
        match self {
            Call::TransferPallet(call) => Some(call),
            _ => None,
        }
    }
}
...
{
    fn from(
        call : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: dispatch :: CallableCallFor < TransferPallet , Runtime >,
    ) -> Self {
        Call::TransferPallet(call)
    }
}
...
pub struct GenesisConfig {
    ...
    pub transfer_pallet: TransferPalletConfig,
}
#[doc(hidden)]
#[allow(non_upper_case_globals, unused_attributes, unused_qualifications)]
const _: () = {
...
const _: () = {
    ...
    impl<'de> __genesis_config_serde_import__::Deserialize<'de> for GenesisConfig {
            ...
            __D: __genesis_config_serde_import__::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "transferPallet" => _serde::__private::Ok(__Field::__field1),
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"transferPallet" => _serde::__private::Ok(__Field::__field1),
                        _ => {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    let mut __field0: _serde::__private::Option<SystemConfig> =
                        _serde::__private::None;
                    let mut __field1: _serde::__private::Option<TransferPalletConfig> =
                        _serde::__private::None;
                        ...
                        match __key {
                            ...
                            __Field::__field1 => {
                                ...
                                __field1 = _serde::__private::Some(
                                    match _serde::de::MapAccess::next_value::<TransferPalletConfig>(
                                        &mut __map,
                                    ) {
                                        _serde::__private::Ok(__val) => __val,
                                        _serde::__private::Err(__err) => {
                    ...
                    let __field1 = match __field1 {
                        ...
                        _serde::__private::None => {
                            match _serde::__private::de::missing_field("transferPallet") {
                                _serde::__private::Ok(__val) => __val,
                                _serde::__private::Err(__err) => {
                                    return _serde::__private::Err(__err);
                                }
            ...
            const FIELDS: &'static [&'static str] = &["system", "transferPallet"];
...
impl ::core::default::Default for GenesisConfig {
    ...
    fn default() -> GenesisConfig {
        GenesisConfig {
            ...
            transfer_pallet: ::core::default::Default::default(),
        }
    }
}
#[cfg(any(feature = "std", test))]
    ...
    for GenesisConfig
{
    fn assimilate_storage(
        ...
        self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_runtime :: BuildModuleGenesisStorage :: < Runtime , transfer_pallet :: __InherentHiddenInstance > :: build_module_genesis_storage (& self . transfer_pallet , storage) ? ;
